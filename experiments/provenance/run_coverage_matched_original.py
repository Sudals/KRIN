...
The original coverage_runs.csv remains unchanged. Training and input masks are
...
from run_infoexp import free_on, region, realised_shift, REGION_FRAC, ALPHA
...
def main():
    ...
    if args.resume and provenance.exists():
        ...
        for field in ("source_sha256", "source_code_sha256", "config"):
            if metadata[field] != previous_metadata[field]:
